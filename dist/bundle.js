...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue, clipboard, contentVM, getDate, getTitle;
	...
	getTitle = __webpack_require__(70);
	...
	contentVM = new Vue({
	  ...
	  created: function() {
	    ...
	    this.$watch("text", function(a) {
	      return localStorage.setItem("text", a);
	    });
	    prev = localStorage.getItem("prev");
	    if (prev) {
	      this.prev = prev;
	    }
	    return this.$watch("prev", function(a) {
	      return localStorage.setItem("prev", a);
	    });
	  },
	  methods: {
	    addBreak: function(t) {
	    ...
	    format: function(text) {
	      return this.addBreak(this.addDate(text));
	    },
	    add: function(text) {
	      if (this.order) {
	        return this.text = "" + (this.format(text)) + this.text;
	      } else {
	        return this.text += this.format(text);
	      }
	    },
	    enable: function() {
